if (
  (!(function (e, n, t, r) {
    ...
    if (((o[s] = t), !o[t])) {
      ...
      var u = a.getElementsByTagName("head")[0],
        ...
        f = navigator.userAgent.toLocaleLowerCase(),
        p = i(),
        h = "";
      (h =
        e.length - 3 === e.indexOf(".js")
          ? e
          : ["//", e, "/source/", n, "/", p, ".", "js"].join("")),
        (l.defer = l.async = !0),
        (l.charset = "utf-8"),
        (l.src = h),
  ...
  var tmp = Analytics;
  (Analytics = function () {}), Object.assign(Analytics, tmp);
}
Analytics("config", "appnm", "movie"),
  Analytics("config", "alwaysSendReferrer", !0),
  Analytics("use", "movie"),
  Analytics("set", "uid", window.system ? system.uid : ""),
  window.openPlatform &&
    Analytics("get", "utm", function (e) {
      (e = e || {}),
        (e.utm_campaign = "openPlatform=" + encodeURIComponent(openPlatform)),
        window.openPlatformSub &&
          (e.utm_campaign += "-" + encodeURIComponent(window.openPlatformSub)),
        Analytics("set", "utm", e);
    }),
  (function (e) {
    var n = /(Googlebot|Baiduspider|360Spider|Sogou web spider|bingbot)/,
      t = navigator.userAgent;
    analytics = function (r) {
      ("send" !== r && "event" !== r) ||
        n.test(t) ||
        e.apply(this, [].slice.call(arguments, 0));
    };
  })(Analytics),
  analytics("send", "pv", { cid: window.cid, val: window.val }),
  !(function (e, n, t) {
    function r() {
      var e = n.createElement("script");
      (e.async = !0),
        (e.src = "https://s0.meituan.net/bs/js/?f=mta-js:mta.min.js");
      var t = n.getElementsByTagName("script")[0];
      t.parentNode.insertBefore(e, t);
    }
    if (
      ((e.MeituanAnalyticsObject = t),
      (e[t] =
        e[t] ||
        function () {
    ...
    if (n && !("_mta" in n)) {
      ...
      if ("file:" !== r) {
        ...
        n.prototype.open = function (n, t, a, s, c) {
          if (
            ((this._method = "string" == typeof n ? n.toUpperCase() : null), t)
          ) {
            if (
              0 === t.indexOf("http://") ||
              0 === t.indexOf("https://") ||
              ...
              this._url = t;
            else if (0 === t.indexOf("/")) this._url = r + "//" + i + t;
            else {
            ...
            -1 !== l
              ? ((this._searchLength = this._url.length - 1 - l),
                (this._url = this._url.substring(0, l)))
              : (this._searchLength = 0);
          } else (this._url = null), (this._searchLength = 0);
          return (
            (this._startTime = new Date().getTime()), o.apply(this, arguments)
          );
        };
            ...
            if (0 !== t._url.indexOf(r + "//frep.meituan.net/_.gif")) {
              ...
              if (t.response)
                switch (t.responseType) {
                  ...
                  case "document":
                    u =
                      t.response.documentElement &&
                      t.response.documentElement.innerHTML &&
                      t.response.documentElement.innerHTML.length + 28;
                    break;
                  default:
                    u = t.response.length;
                }
              e.mta("send", o, {
                ...
                method: t._method,
                error: !(
                  0 === t.status.toString().indexOf("2") || 304 === t.status
                ),
          ...
          if (s in this) {
            ...
            this[a] = function (n) {
              o && o.apply(this, arguments),
                4 === this.readyState && e.mta && t(this, n);
            };
          }
  ...
  mta("create", "5732dc750ea11a1c3db93a1c"),
  ...
  (function (e, n) {
    ...
    function t(e, n) {
      ...
      (n = n || {}),
        ...
        document.createEvent
          ? ((t = document.createEvent("HTMLEvents")), t.initEvent(e, !0, !0))
    ...
    function l(e) {
      return (
        (c(e) && "[object Error]" === W.toString.call(e)) || e instanceof Error
      );
    }
    function f(e, n) {
    ...
    function p(e, n) {
      var t, r;
      if (o(e.length)) for (t in e) f(e, t) && n.call(null, t, e[t]);
      else if ((r = e.length)) for (t = 0; t < r; t++) n.call(null, t, e[t]);
    }
    function h(e, n) {
      var r = [];
      e.stack &&
        e.stack.length &&
        p(e.stack, function (e, n) {
          var t = m(n);
          t && r.push(t);
        }),
        t("handle", { stackInfo: e, options: n }),
        d(e.name, e.message, e.url, e.lineno, r, n);
    }
    function m(e) {
      if (e.url) {
        var n,
        ...
        return (
          (t.in_app = !(
            (D.includePaths.test && !D.includePaths.test(t.filename)) ||
    ...
    function g(e) {
      if (e.context && D.fetchContext) {
        for (
          var n = e.context, t = ~~(n.length / 2), r = n.length, i = !1;
          r--;
    ...
    function d(e, n, t, r, i, o) {
      var a, s;
      (D.ignoreErrors.test && D.ignoreErrors.test(n)) ||
        ((n += ""),
        (n = x(n, D.maxMessageLength)),
        (s = e + ": " + n),
        (s = x(s, D.maxMessageLength)),
        i && i.length
          ? ((t = i[0].filename || t), i.reverse(), (a = { frames: i }))
          : t && (a = { frames: [{ filename: t, lineno: r, in_app: !0 }] }),
        (D.ignoreUrls.test && D.ignoreUrls.test(t)) ||
          (D.whitelistUrls.test && !D.whitelistUrls.test(t)) ||
          b(
            v(
              {
                exception: { type: e, value: n },
                stacktrace: a,
                culprit: t,
                message: s,
              },
    ...
    function b(e) {
      var n = { project: I, logger: D.logger, platform: "javascript" },
        r = w();
      r && (n.request = r),
        (e = v(n, e)),
        (e.tags = v(v({}, D.tags), e.tags)),
        (e.extra = v(v({}, D.extra), e.extra)),
        (e.extra = v({ "session:duration": y() - J }, e.extra)),
        u(e.tags) && delete e.tags,
        M && (e.user = M),
        D.release && (e.release = D.release),
        a(D.dataCallback) && (e = D.dataCallback(e) || e),
        e &&
          !u(e) &&
          ((a(D.shouldSendCallback) && !D.shouldSendCallback(e)) ||
            ((L = e.event_id || (e.event_id = O())),
            C("debug", "Raven about to send:", e),
            _() &&
              (D.transport || E)({
                url: N,
                auth: {
                  sentry_version: "4",
                  sentry_client: "raven-js/" + X.VERSION,
                  sentry_key: F,
                },
                data: e,
                options: D,
    ...
    function E(e) {
      ...
      var n = S(),
        t = e.url + "?" + R(e.auth);
      (e.options.crossOrigin || "" === e.options.crossOrigin) &&
        (n.crossOrigin = e.options.crossOrigin),
        (n.onload = e.onSuccess),
        (n.onerror = n.onabort = e.onError),
        (n.src = t);
    }
    function S() {
    ...
    function _() {
      return (
        !!q &&
        (!!N ||
          (K || C("error", "Error: Raven has not been configured."),
          (K = !0),
          !1))
      );
    }
    ...
    (j.wrap = function (e) {
      ...
      (j.report = (function () {
        ...
        function a(e, n, t, r, i) {
          var a = null;
          if (v)
            j.computeStackTrace.augmentStackTraceWithInitialElement(v, n, t, e),
              u();
          else if (i) (a = j.computeStackTrace(i)), o(a, !0);
          else {
            var s = { url: n, line: t, column: r };
            (s.func = j.computeStackTrace.guessFunctionName(s.url, s.line)),
              (s.context = j.computeStackTrace.gatherContext(s.url, s.line)),
              (a = { message: e, url: document.location.href, stack: [s] }),
              o(a, !0);
          }
      ...
      (j.computeStackTrace = (function () {
        ...
        function i(e, n) {
          ...
          var i = [],
            a = Math.floor(j.linesOfContext / 2),
            s = a + (j.linesOfContext % 2),
            c = Math.max(0, n - a - 1),
        ...
        function l(e, n, r) {
          ...
          return (
            (r -= 1), o && o.length > r && (i = s.exec(o[r])) ? i.index : null
          );
        }
        function p(n) {
          for (
          ...
          if (!o(e.stack) && e.stack) {
            for (
              var n,
                t,
                a =
                  /^\s*at (.*?) ?\(?((?:(?:file|https?|chrome-extension):.*?)|<anonymous>):(\d+)(?::(\d+))?\)?\s*$/i,
                s =
                  /^\s*(.*?)(?:\((.*?)\))?@((?:file|https?|chrome).*?):(\d+)(?::(\d+))?\s*$/i,
                c =
                  /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:ms-appx|http|https):.*?):(\d+)(?::(\d+))?\)?\s*$/i,
                u = e.stack.split("\n"),
                f = [],
              ...
              !t.func && t.line && (t.func = r(t.url, t.line)),
                t.line && (t.context = i(t.url, t.line)),
                f.push(t);
            }
            return f.length
              ? (f[0].line && !f[0].column && p
                  ? (f[0].column = l(p[1], f[0].url, f[0].line))
                  : f[0].column ||
                    o(e.columnNumber) ||
        ...
        function m(e) {
          ...
          if (!o(e.stacktrace) && e.stacktrace) {
            for (
              var t,
                a =
                  / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\) in (.*):\s*$/i,
                s = n.split("\n"),
                c = [],
                u = 0,
                l = s.length;
              ...
              if ((t = a.exec(s[u]))) {
                ...
                if ((!f.func && f.line && (f.func = r(f.url, f.line)), f.line))
                  try {
        ...
        function g(n) {
          ...
          var a,
            ...
            p,
            h =
              /^\s*Line (\d+) of linked script ((?:file|https?)\S+)(?:: in function (\S+))?\s*$/i,
            m =
              /^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?)\S+)(?:: in function (\S+))?\s*$/i,
          ...
          for (s = 2, l = o.length; s < l; s += 2) {
            var y = null;
            if ((a = h.exec(o[s]))) y = { url: a[2], func: a[3], line: +a[1] };
            else if ((a = m.exec(o[s]))) {
              y = { url: a[3], func: a[4] };
              var w = +a[1],
                b = x[a[2] - 1];
              if (b && (p = t(y.url))) {
        ...
        function v(e, n) {
          for (
            ...
            if (f !== x && f !== j.report) {
              if (
                ((i = { url: null, func: U, line: null, column: null }),
                f.name
                  ? (i.func = f.name)
                  : (t = a.exec(f.toString())) && (i.func = t[1]),
              ...
              if ((o = p(f))) {
                (i.url = o.url),
                  (i.line = o.line),
                  i.func === U && (i.func = r(i.url, i.line));
        ...
        var y = {};
        return (
          (x.augmentStackTraceWithInitialElement = d),
          (x.computeStackTraceFromStackProp = h),
          (x.guessFunctionName = r),
          (x.gatherContext = i),
          x
        );
      })());
    var $,
      ...
      I,
      P = e.Raven,
      q = !("object" != typeof JSON || !JSON.stringify),
      D = {
        logger: "javascript",
        ignoreErrors: [],
        ignoreUrls: [],
    ...
    var X = {
      ...
      config: function (e, n) {
        ...
        return (
          ...
          (D.ignoreErrors = k(D.ignoreErrors)),
          (D.ignoreUrls = !!D.ignoreUrls.length && k(D.ignoreUrls)),
          (D.whitelistUrls = !!D.whitelistUrls.length && k(D.whitelistUrls)),
          (D.includePaths = k(D.includePaths)),
          (F = t.user),
          (I = t.path.substr(r + 1)),
          (N =
            "//" +
            ...
            I +
            "/store/"),
          t.protocol && (N = t.protocol + ":" + N),
          D.fetchContext && (j.remoteFetching = !0),
          D.linesOfContext && (j.linesOfContext = D.linesOfContext),
          (j.collectWindowErrors = !!D.collectWindowErrors),
          X
        );
      },
      install: function () {
      ...
      context: function (e, t, r) {
        return (
          a(e) && ((r = t || []), (t = e), (e = n)), X.wrap(e, t).apply(this, r)
        );
      },
      wrap: function (e, t) {
        function r() {
          for (
            var n = [], r = arguments.length, i = !e || (e && e.deep !== !1);
            r--;

          )
            n[r] = i ? X.wrap(e, arguments[r]) : arguments[r];
          try {
      ...
      captureMessage: function (e, n) {
        if (!D.ignoreErrors.test || !D.ignoreErrors.test(e))
          return b(v({ message: e + "" }, n)), X;
      },
    ...
    var t = function (t) {
      ...
      e[t] = function () {
        var e = [].slice.call(arguments),
          t = e[0];
        return (
          "function" == typeof t && (e[0] = n.wrap(t)),
  ...
  Raven.config(
    "http://5d54bac77cc04401ba8fca7a7b1d4c8c@sentry7.meituan.com/422",
    { whitelistUrls: ["maoyan.com", "anonymous"] }
  ).install();
